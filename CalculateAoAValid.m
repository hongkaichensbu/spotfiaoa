...
for k = 1:length(files)
 ...
 %       fig1=figure(1);
        ...
        for ii=1:data_size
            ...
            %%% shutdown..
            if ii==1000
                matname_aoa = strcat(dataDir,'aoadata/',figname,'-aoa-nPaths-',num2str(i),off_cfg,'-20mhz.mat');
                parsave(matname_aoa, totalAOA);
        
                matname_tof = strcat(dataDir,'aoadata/',figname,'-tof-nPaths-',num2str(i),off_cfg,'-20mhz.mat');
